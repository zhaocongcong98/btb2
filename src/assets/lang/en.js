module.exports = {
    ...
    otc: {
        ...
        index: {
            ...
            ibuy: 'I want buy',
            isell: 'I want sell',
            bottom1:"Open transactions on multiple platforms anytime, anywhere",
            bottom2: "Download the JINGUI Android APP or IOS APP mobile client, watch the market, the second trading experience, your trading trip is about to begin.",
            logoTitle:'The world\'s leading digital asset exchange',
            logoText1:'Catch',
            logoText2:'Excellence',
            logoText3:'Lead',
            more: 'more>>',
        }
    },
    ...
    description: {
        title1: 'Financial security',
        title2: 'Fast and convenient product experience',
        title3: 'Global quality and fast',
        title4:'24-hour online service',
        message1: 'Multi-level firewall, multi-signature, hot and cold isolation wallet, core steps are handled by disconnected network to ensure user asset security.',
        message2: 'Rich development experience makes our product features, access speed, and high concurrent trading capabilities far ahead in the industry.',
        message3: 'Recharge cash withdrawal and quick arrival T+O transaction one-click transaction.',
        message4: 'Mature customer service and technical support systems respond quickly to user needs, solve operational problems and allow you to focus on trading.'
    },
    footer: {
        gsmc: 'International Digital Encryption Asset Trading Platform',
        ul1:'Terms and conditions',
        ul1li1:'User Agreement',
        ul1li2:'Terms and conditions',
        ul2:'tool',
        ul2li1:'API',
        ul2li2:'Operation Manual',
        ul3:'about',
        ul3li1:'About jingui',
        ul3li2:'Project dynamics',
        ul3li3:'Industry information',
        ul3li4:'Official Announcement',
        ul3li5:'Coin application',
        ul4:'contact us',
        ul4li1:'Customer Service Email',
        ul4li2:'Media mailbox',
        ul4li3:'Community mailbox',
        ul4li5:'International Business Cooperation Email',
        ul4li6:'Apply for WeChat on the foreign currency',
        notice:"Risk Warning: Due to the high risk of digital currency trading, it is vulnerable to external factors, currency and other factors, and the price fluctuation is large. We strongly recommend that you participate in digital currency trading within the risk range that you can bear! Investment is risky and requires caution when entering the market."
    },
    index: {
    ...
    homeadd:{
        introduce:{
            title:'Digital asset trading platform serving global users',
            p1:'JINGUI trading platform is one of the earliest established trading platforms in the world, with registered users in more than 100 countries and regions around the world.It has been established: Russia Station, Europe Station, Southeast Asia, Brazil, North America Station, Japan and South Korea, and other sub-stations, global business team and service system to provide users with safe and convenient, high quality and intimate',
            p2:'JINGUI\'s business segments include: JINGUI trading platform, JINGUIATM, JINGUIPOS and other related financial services in the digital currency field.'
        },
        mapbox:{
            title:'BOBIT Global Alliance Substation System',
            p:'In the future, we will open more sub-stations in major countries and regions around the world to provide better service to users.',
            city1:'Russia',
            city2:'Europe',
            city3:'Japan and South Korea',
            city4:'Southeast Asia',
            city5:'Africa',
            city6:'Brazil',
            city7:'North America',
            city8:'Australia',
        ...
        pricebox:{
            today:'Total station volume today',
            btcprice1:'BTC market price',
            ethprice1:'ETH market price',
        },
        welcome:{
            title:'Welcome to the JINGUI trading platform community',
            p:'JINGUI trading platform users in more than 100 countries and regions, sharing trading experience with global fans to capture market trends.',
        },
        cooperation:{
            title:"Partner",
        },
    ...
    ethusdt:{
        ...
        ethexchange:"1ETH exchange price",
        bobotco:"jingui Exchange Eco-Certification",
        plan:"ZFL 100-day snapping plan",
        currentPrice:"Real-time market price",
        todayPrice:"Today's rate",
        exchangeTop: "Daily limit of 10 ETH / 15:00 every day to open on time",
        placehold: "Enter the amount you want to buy (ETH)",
        buy: "buy",
        notStart: "not started",
        notice: "(The daily purchase limit of 10 ETH per person is increasing, the sooner the purchase is cheaper)",
        rule1: "one: zfl snapping rules:",
        rule11: "1, the purchase price: the initial purchase price 1ETH = 10000ZFL, the price increases 10ZFL per day",
        rule12:"2, snapping cycle: 100 days",
        rule13:"3, the total amount of purchase per day: 10 ETH equivalent ZFL",
        rule14:"4, per person per day limit purchase: 10 ETH equivalent ZFL",
        rule15:"5, buy ZFL is locked state, and open linear unlock from the second day of the purchase, automatically unlock 3 每天 every day (about 333 days release), can accelerate unlock, up to 5 times acceleration: unlock 15 每天 every day (about Released in 66 days).",
        rule2: "two: ZFL acceleration unlock rules:",
        rule21: "1. The default release rate of all snapped ZFLs is 3% of the unlocked holdings per day, and the ZFLs purchased in the secondary market do not lock positions.",
        rule22:"2. When the number of valid invitations reaches 6 people, the next day will automatically activate the double acceleration to unlock, and the unlocking speed is 6% per day.",
        rule23:"3. When the number of valid invitations reaches 6 at the first level, the number of valid invitations at the second level reaches 12, and the next day automatically activates triple acceleration to unlock, and the unlocking speed is 9% per day.",
        rule24:"4. When the number of valid invitations reaches 8 at the first level, the number of valid invitations at the second level reaches 20, and the next day automatically activates four times to accelerate the unlocking, and the unlocking speed is 12% per day.",
        rule25:"5. When the number of valid invitations reaches 12, the number of valid invitations at the second level is 56, and the next day automatically activates five times to accelerate the unlocking, and the unlocking speed is 15% per day.",
        rule26: "Valid invitation means: the account recharge amount is greater than or equal to 10 ETH is a valid invitation.",
        rule3: "three: ZFL snapped up the rebate rules:",
        rule31: "1. Rebate according to the corresponding proportion of the invited person to buy ZFL amount",
        rule32:"Level 1 invitation rebate 10% (including 5% ETH + 5% ZFL lock warehouse rebate)",
        rule33:"Secondary invitation rebate 5% (including 2.5% ETH + 2.5% ZFL lock warehouse rebate)",
        rule34:"2. The ETH of the rebate does not lock the position, and the ZFL of the rebate implements the lock position. The unlocking condition is the same as that of the ZFL obtained by snapping up, and also enjoys the acceleration right.",
        rule35:"3. Each time the successful purchase of the rebate will be settled on the next day.",
        rule36: "For example: the first-level invitee snapped up 10,000 ZFL with 1,000 ETH (the purchase price is 0.1 ETH), and the second-level invitee snapped up 3,000 ZFL with 600 ETH (buy price 0.2 ETH), the inviter will get",
        rule37: "Level 1 rebate: 1,000 x 5% = 50 ETH (direct return), 10,000 x 5% = 500ZFL ( unlock 3% per day)",
        rule38: "Secondary rebate: 600 x 2.5% = 15 ETH (direct return), 3,000 x 2.5% = 75 ZFL (3% unlocked per day)",
        rule39: "Total: 75 ETH and 575 ZFL",
        service: "Contact Customer Service",
        title: "The jingui trading platform has the final interpretation right for this activity, and the changes to the activity rules will be effective as soon as they are announced."

    },
    add: {
        announcement:'announcement',
        help:'Help',
        launchpadtitle: "Blockchain asset issuance platform",
        all:'All',
        ing:'Ongoing',
        end:'Has ended',
        newest:'Latest price',
        hour24:'24h ups and downs',
        highest:'24h highest price',
        lowest:'24h lowest price',
        transaction:'24h volume',
        please:'please',
        select:"Select",
        notdata:"Not Data",
        more:"see more>>",
        ...
        launchpadManagement:"Launchpad Management",
        myPromotion:"My Promotion",
        sponsoredUrl:"Sponsored Url",
        memberDetails:"Member Details",
        name:"name",
        tel:"cellphone number",
        rechargeETH:"recharge ETH",
        rechargeBTC:"recharge BTC",
        rechargeUSDT:"recharge USDT",
        tradingPlatform:"Trading platform",
        mainingTitle:"We give you the right to use your own money in your own way on an unbounded payment platform. Buy, store and redeem your digital or traditional currency anytime, anywhere...",
        totall:"Amount:",
        startTime:"Start Time：",
        endTime:"End Time:",
        notAccount:"No account",
        goregister:"Registered",
        aboutUs:"About Us",
        aboutText:"JINGUI Exchange is a blockchain digital asset exchange registered in Hong Kong. It provides matching trading services for digital assets such as Bitcoin, Ethereum, Litecoin and Dogecoin to global users. It is operated by JINGUI. JINGUI Exchange is founded by the world's top technical team and professional digital asset enthusiasts. The core team is from well-known companies such as Microsoft, Tencent and Ali. It aims to provide users with safer, convenient, high-quality and transparent blockchain asset trading and exchange. Service, aggregating global high-quality blockchain assets, committed to building a world-class blockchain asset trading platform",
        read:" read",
        getAmount:"Number of arrivals",
        dynamic_1:"TRX is about to go online BTC, ETH, USDT trading area",
        dynamic_2:"NIOX online NSD trading area announcement",
        dynamic_3:"PROT online BTC trading area announcement",
        dynamic_4:"RPZX online BTC trading area announcement",
        dynamic_5:"Nerthus (NTS) online USDT trading area announcement",
        dynamic_6:"Announcement on RET withdrawal",
        dynamic_7:"Dentacoin (DCN) online USDT trading area announcement",
        dynamic_8:"Stellar (XLM) on the line more than BTC, USDT trading area announcement",
        news_1: "US Congress Hearing: Changing the World with Blockchain Technology",
        news_2:"Introduction to OCTOWILL",
        news_3:"South Korea's The Wing Corp and JINGUI trading platform strategic cooperation successfully signed, JINGUI enters the overseas market to sail",
        news_4:"JINGUI and knowing Chuangyu reached a strategic cooperation to protect JINGUI ecological safety",
        news_5:"Compared with buying a house, 21% of the UK’s Qianxi generation is more willing to buy coins.",
        news_6:"The Hilton family loves cryptocurrencies and wants to sell $38 million in luxury homes in bitcoin.",
        news_7:"John McAfee bets on eating shoes: the last bitcoin is worth $500 billion",
        add_1:"Platform announcement",
        add_2:"Limit price",
        add_3:"market price",
        add_4:"Buy",
        add_5:"Buy out",
        add_6:"search",
        add_7:"Empty condition",
        add_8:"Please select a search date range",
        add_9:"Coin currency address QR code",
        add_10:"Promote QR code",
        add_11:"The audit failed",
        add_12:"Please try again",
        add_13:"forget password?",
        add_14:"prompt",
        add_15:"Help center",
        add_16:"Articles in this group",
        add_17:"Help center",
        add_18:"please log in",
        add_19:"Verified",
        add_20:"Please",
        add_21:"order details",
        add_22:"forget password",
        add_23:"Promote QR code",
        add_24:'Invitation code',
        add_25:"sponsored links:",
        add_26:"Announcement list",
        add_27:"Previous",
        add_28:"Next",
        add_29:"JINGUI Global Leading Blockchain | Virtual Coin | Digital Asset Trading Platform",
        currencyType: "currency：",
        start_end_tiime:"start_end_time:",
        jiaoyidui: "Transaction pair",
        type:"Types",
        direction:"Direction:",
        endAmount:"Turnover",
        select_input:"select",
        otcMain_1: "Market price",
        otcMain_2:"Real-time fluctuations based on market prices",
        otcMain_3:"Completely free of charge",
        otcMain_4:"User WYSIWYG, trading price, no platform fee",
        otcMain_6:"Immediate transaction",
        otcMain_7:"Introducing platform service merchants, intelligent matching, and closing orders without waiting for a match",
        otcMain_8:"Platform guarantee",
        otcMain_9:"Platform certified merchants, safe and secure, 24-hour customer service escorts for transactions",
        otcMain_10:"Legal currency trading",
        otcMain_11:"Convenient, secure, and fast trading of digital currencies",
        otcMain_12:"Become business",
    },
    zfl:{
        title:"Initial public offering",
        page1title:"I pay by my own method. I pay by ZFL",
        page1text:"We give you the right to use your own money in an own way on an unbounded payment platform. Buy, store and redeem your digital or traditional currency anytime, anywhere",
        page2title:"One card tube all",
        page2text:"Your new generation of multi-currency travel cards. The ZFL Visa card automatically converts over 20 digital currencies and traditional currencies at the point of sale, allowing you to seamlessly consume your cryptocurrencies and traditional currencies in real life, as long as Visa is supported there. card. Can your bank card do it?",
        zflLeft1:"Token name:",
        zflLeft2:"total amount:",
        zflLeft3:"Starting time:",
        zflLeft4:"End Time:",
        zflLeft5:"Time to market:",
        zflLeft6:"Acceptable currency:",
        zflRight1:"ZFL",
        zflRight2:"300,000,000 ZFL",
        zflRight3:"September 24, 2019 (GMT + 8)",
        zflRight4:"September 24, 2019 (GMT + 8)",
        zflRight5:"December 24, 2019 (GMT)",
        invite:"Invitation code:",
        url:"link:",
    },
    apiDocument:{
        menu_1 :"Authorization",
        menu_11:"API authorization",
        menu_2 :"Trading API",
        menu_21:"Order",
        menu_22:"Cancel order",
        menu_23:"All commission",
        menu_24:"Current commission",
        menu_25:"Trading Rules",
        menu_26:"market place",
        menu_3 :"Quote API",
        menu_31:"Latest market",
        menu_32:"Market pending order",
        menu_33:"Transaction Record",
        menu_34:"K line",
        menu_4 :"User API",
        menu_41:"K line",
        p_1:"JINGUI trading platform open API",
        p_2:"The application can obtain assets, transactions and other data by calling the API provided by the JINGUI open platform. Because it involves data privacy, JINGUI must be obtained before use.",
        p_3:"Authorization",
        p_4:"(get after login), you can call the API",
        p_5:"Common parameter",
        p_6:"Request address",
        p_7:"environment",
        p_8:"Formal environment",
        p_9:"parame",
        p_10:"Required or not",
        p_11:"description",
        p_12:"Sample value",
        p_13:"yes",
        p_14:"Fixed to",
        p_15:"no",
        p_16:"Zh-*: Chinese, en-*: English, default (Chinese)",
        p_17:"Public request parameter",
        p_18:"Types of",
        p_19:"The maximum length",
        p_20:"API access key",
        p_21:"Unix timestamp",
        p_22:"Interface version, fixed at 1.0",
        p_23:"Request signature string, see for details",
        p_24:"signature",
        p_25:"Public response parameter",
        p_26:"Parameter Type",
        p_27:"0 failed 1 successful 2 error",
        p_28:"Return status description",
        p_29:"Successful operation",
        p_30:"Request response data",
        p_31:"request",
        p_32:"Request method",
        p_33:"Request parameter",
        p_34:"Need to pass public parameters",
        p_35:"Response parameter",
        p_36:"User bound mobile phone number",
        p_37:"User assets, btc_over is btc available, btc_lock is btc frozen, other currency push",
        p_38:"Request example",
        p_39:"HTTP request",
        p_40:"Response example",
        p_41:"JSON sample value",
        p_42:"Signature algorithm",
        p_43:"(The following is a complete example)",
        p_44:"Step 1. Sort the key of the parameter in Ascii ascending order, for example",
        p_45:"Step 2, assembling into a string, and doing URL-encode (otherwise special characters will cause the signature to fail), get a queryString, for example:",
        p_46:"Step 3. Encrypt the secret key (example value: fe01ce2a7fbac8fafaed7c982a04e229) and queryString with the HMAC-SHA1 algorithm to obtain a signature string, for example:",
