                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-else-if="user.realVerified==0&&user.realAuditing==0&&user.realNameRejectReason!=null" class="bankInfo" style="color: #f0a70a;">
                                    {{$t('add.add_11')}}{{user.realNameRejectReason?"："+user.realNameRejectReason:""}}，{{$t('add.add_12')}}。
                                </p>
                                ...
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85" style="text-align:center;">
                                        ...
                                        <div style="height:350px;">
                                            ...
                                            <img id="frontCardImg" style="width: 260px;height: 175px;" :src="frontCardImg">
                                            <div class="acc_sc">
                                            ...
                                            <img id="backCardImg" style="width: 260px;height: 175px;" :src="backCardImg">
                                            <div class="acc_sc">
                                            ...
                                            <img id="handCardImg" style="width: 260px;height: 175px;" :src="handCardImg">
                                            <div class="acc_sc">
                                        ...
                                        <span v-if="lang==='Chinese'" class="uploadimgtip">提示：上传图片仅支持.jpg、.gif、.png、.jpeg格式，且推荐大小为100kb-1024kb，否则有可能上传失败。</span>
                                ...
                                <div class="detail-list" v-show="user.fundsVerified==1  && !fGetBackFundpwd">
                                    <Form ref="formValidate5" :model="formValidate5" :rules="ruleValidate" :label-width="95">
                                        ...
                                        <p style="text-align:right;">
                                            <a @click="handleReset('formValidate8');fGetBackFundpwd=!fGetBackFundpwd" style="color:#f0ac19;">{{$t('add.add_13')}}</a>
                                        </p>
                                        <!-- Button -->
                                        <FormItem>
