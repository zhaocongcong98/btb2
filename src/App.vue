        ...
        <div class="layout-ceiling">
          ...
          <div class="layout-ceiling-main">
            ...
            <div class="header_nav">
              <Menu :active-name="activeNav" width="auto" :open-names="['1']" style="background:none">
                <Submenu name="1">
                  <router-link to="/">
                  ...
                  <router-link to="/otc/trade/qc">
                    <MenuItem name="nav-otc">OTC</MenuItem>
                  </router-link>
            ...
            <div class="rr">
                 <div class="lang-button" @click="showLang">
                {{languageValue}}
                <ul class="lang-box" ref="langbox">
                <li class="change-lan" @click="changelanguage('en')" >
               English
              </li>
              <li class="change-lan" @click="changelanguage('cn')" >
                Chinese
              </li>
              </ul>
              </div>
              ...
              <div class="login_register isLogin" v-if="isLogin">
                <div class="mymsg">
                  <router-link to="/uc/safe">{{$t("common.person")}}</router-link>
                </div>
                <Dropdown>
    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          <img src="./assets/images/logo.png" style="margin:0;width:122px;height:28px;">
          <!-- <h3>Caymanex.Pro</h3> -->
          <p>{{$t("footer.gsmc")}}</p>
          <p>Copyright © 2018 - 2019&nbsp;&nbsp;</p>
          <p class="footer-notice">{{$t("footer.notice")}}</p>
        </div>
        <div class="footer_right">
          <ul>
            <li class="footer_title">
              <span style="color:#fdc101">{{$t("footer.ul1")}}</span>
            </li>
             <li>
              <router-link to="/useragreement">{{$t("footer.ul1li1")}}</router-link>
            </li>
             <li>
               <router-link to="/terms">{{$t("footer.ul1li2")}}</router-link>
            </li>
          </ul>
          <ul>
            <li class="footer_title">
              <span style="color:#fdc101">{{$t("footer.ul2")}}</span>
            </li>
            <li>
              <router-link to="/api">{{$t("footer.ul2li1")}}</router-link>
            </li>
            <!--  <li>
               <router-link to="/operationmanual">{{$t("footer.ul2li2")}}</router-link>
            </li> -->
          </ul>
          <ul>
            <li class="footer_title">
              <span style="color:#fdc101">{{$t("footer.ul3")}}</span>
            </li>
            <li>
              <router-link to="/about-us">{{$t("footer.ul3li1")}}</router-link>
            </li>
             <li>
               <router-link to="/dynamic">{{$t("footer.ul3li2")}}</router-link>
            </li>
             <li>
               <router-link to="/news">{{$t("footer.ul3li3")}}</router-link>
            </li>
             <li>
               <router-link to="/notice">{{$t("footer.ul3li4")}}</router-link>
            </li>
          </ul>
          <ul>
            <li class="footer_title">
              <span style="color:#fdc101">{{$t("footer.ul4")}}</span>
            </li>
            <li>
              {{$t("footer.ul4li1")}}:
              jinguics@gmail.com
             ...
             <li>
              {{$t("footer.ul4li2")}}:
              jinguimedia@gmail.com
            </li>
             <li>
              {{$t("footer.ul4li3")}}:
              jinguicommunity@gmail.com
            </li>
             <li>
              {{$t("footer.ul4li5")}}:
              jinguiinternational@gmail.com
            </li>
          </ul>
          <!-- <ul>
            <li class="footer_title">
...
export default {
    ...
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          break;
        default:
          window.document.title = this.$t('add.add_29');
          break;
      }
    },
    $route(to, from) {
  ...
  computed: {
    ...
    lang() {
      if(this.$store.state.lang === "Chinese"){
        this.$i18n.locale = "zh";
        if(window.tvWidget){
          window.tvWidget.setLanguage("zh");
        }
      }else{
        this.$i18n.locale = "en";
        if(window.tvWidget){
          window.tvWidget.setLanguage("en");
        }
      } 
  ...
  methods: {
    showLang:function(){
      let status = this.$refs.langbox.style.display;
      if(status == "block"){
        this.$refs.langbox.style.display = "none";
      }else{
        this.$refs.langbox.style.display = "block";
      }
    },
    strpo(str) {
      if (str.length > 4) {
    ...
    changelanguage: function(name) {
      ...
      if (name == "cn") {
        this.$store.commit("setlang", "Chinese");
        this.$i18n.locale = "zh";
       if(window.tvWidget){
          window.tvWidget.setLanguage("zh");
        }
    ...
    changePic:function(newval){
       this.$refs.child.changePic(newval);
    },
  }
};
</script>
...
.change-lan:hover {
  color: rgb(255, 187, 3);
  border: 2px solid rgb(255, 187, 3);
}
.header_nav .ivu-menu:after {
  background: none;
}
.page-view2 .nav-pdf {
  color: #333;
