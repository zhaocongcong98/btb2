                    ...
                    <Tabs value="name1">
                        <TabPane :label="$t('otc.checkuser.tablabel1')" name="name1" >
                            <div class="order-table">
                                <Table :columns="tableColumnsOrderSell" :data="tableOrderSell" :loading="loading" :disabled-hover="true" :no-data-text="$t('common.nodata')"></Table>
                        ...
                        <TabPane :label="$t('otc.checkuser.tablabel2')" name="name2">
                            <div class="order-table">
                                <Table :columns="tableColumnsOrderBuy" :data="tableOrderBuy" :loading="loading" :disabled-hover="true" :no-data-text="$t('common.nodata')"></Table>
                                <!-- <div style="margin: 10px;overflow: hidden">
                                                                            <div style="float: right;">
                                                                                <Page :total="100" :current="1" @on-change="changePage"></Page>
                                                                            </div>
