  ...
  <div class="mymsg_wrapper">
    <div class="wrapper">
      <Menu :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true">
        <div class="title">{{$t('add.personal')}}</div>
        <Submenu name="1">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t('add.accountManagement')}}</span>
          </template>
          <MenuItem name="1-1">
        ...
        <Submenu name="2">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t('add.assetManagement')}}</span>
          </template>
          <MenuItem name="2-1">
        ...
        <Submenu name="3">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t('add.coinManagement')}}</span>
          </template>
          <MenuItem name="3-1">
          <router-link to="/uc/entrust/current">{{$t('add.currentCommission')}}</router-link>
          </MenuItem>
          <MenuItem name="3-2">
          <router-link to="/uc/entrust/history">{{$t('add.historicalCommission')}}</router-link>
          </MenuItem>
        </Submenu>
        <Submenu name="4">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t('add.launchpadManagement')}}</span>
          </template>
          <MenuItem name="4-1">
      ...
      <Submenu name="5">
          <template slot="title">
            <span class="isclick"></span>
            <span class="content">{{$t('add.myPromotion')}}</span>
          </template>
          <MenuItem name="5-1">
          <router-link to="/uc/recommend">{{$t('add.sponsoredUrl')}}</router-link>
          </MenuItem>
          <MenuItem name="5-2">
          <router-link to="/uc/member">{{$t('add.memberDetails')}}</router-link>
          </MenuItem>
        </Submenu>
      </Menu>
